...
await page.locator('#reset').click();assert.equal((await state()).farDistance,58);assert.equal((await state()).musicVolume,1);assert.equal((await state()).hitVolume,1);assert.equal(await page.locator('#volume').inputValue(),'0.3');assert.equal(await page.locator('#musicVolume-value').innerText(),'100%');assert.equal(await page.locator('#hitVolume-value').innerText(),'100%');
